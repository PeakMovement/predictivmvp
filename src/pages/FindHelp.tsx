...
export function FindHelp() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 pb-nav-safe max-w-4xl scrollable-content">
      ...
      {/* Error */}
      {error && (
        <div className=" border border-destructive/30 bg-destructive/10 p-4 text-center text-sm text-destructive">
          {error}
        </div>
      )}
  ...
  return (
    <div className=" border border-border/50 bg-card/60 rounded-md p-5 flex flex-col gap-3 hover:border-primary/30 transition-colors">
      ...
      <div className="flex gap-2 mt-auto pt-1">
        ...
        <button
          disabled
          className=" border border-border/50 px-4 py-2 text-center text-sm font-medium text-muted-foreground cursor-not-allowed"
        >
          View profile
        </button>
      </div>
