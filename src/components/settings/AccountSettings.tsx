      ...
      <div className="bg-glass rounded-md border border-glass-border p-6 hover:bg-glass-highlight transition-all duration-300">
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            className="w-full flex items-center justify-between p-4 rounded-md border bg-glass/30 border-glass-border hover:bg-glass-highlight transition-all duration-200 h-auto"
            variant="ghost"
          >
          ...
          <AlertDialog onOpenChange={(open) => { if (!open) setDeleteConfirmText(""); }}>
            <AlertDialogTrigger asChild>
              <button className="w-full flex items-center justify-between p-4 rounded-md border bg-destructive/5 border-destructive/20 hover:bg-destructive/10 transition-all duration-200">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-destructive/20 rounded-md flex items-center justify-center">
          ...
          <Button
            ...
            className="w-full flex items-center justify-center p-4 rounded-md border bg-destructive/10 border-destructive/20 hover:bg-destructive/20 transition-all duration-200"
            variant="ghost"
          >
      ...
      <div className="bg-glass rounded-md border border-glass-border p-6 hover:bg-glass-highlight transition-all duration-300">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-between p-4 rounded-md border bg-glass/30 border-glass-border hover:bg-glass-highlight transition-all duration-200"
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-primary/20 rounded-md flex items-center justify-center">
          ...
          <div className="w-full flex items-center justify-between p-4 rounded-md border bg-glass/30 border-glass-border transition-all duration-200">
            <div className="flex items-center gap-3">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-amber/20 rounded-md flex items-center justify-center">
