                ...
                {unacknowledged.length > 0 && (
                  <div className="space-y-2">
                    ...
                    {unacknowledged.map((anomaly) => (
                      <div
                        key={anomaly.id}
                        className="p-4 rounded-md bg-destructive/5 border border-destructive/20 hover:bg-destructive/10 transition-colors"
                      >
                ...
                {acknowledged.length > 0 && (
                  <div className="space-y-2 mt-6">
                    ...
                    {acknowledged.slice(0, 5).map((anomaly) => (
                      <div
                        key={anomaly.id}
                        className="p-3 rounded-md bg-muted/10 border border-glass-border opacity-60"
                      >
