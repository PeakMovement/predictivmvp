...
export const DashboardSkeleton = () => (
  <LoadingContainer>
    <p className="font-mono text-[9px] tracking-[0.3em] uppercase text-marble1/30">Loading dashboard</p>
    <HairlineSweep width="w-32" />
  </LoadingContainer>
);
...
export const HealthPageSkeleton = () => (
  <LoadingContainer>
    <p className="font-mono text-[9px] tracking-[0.3em] uppercase text-marble1/30">Loading health data</p>
    <HairlineSweep width="w-32" />
  </LoadingContainer>
);
