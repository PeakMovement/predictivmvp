    ...
    return (
      <div className="bg-glass rounded-md border border-glass-border p-6 ">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-teal-500/20 rounded-md flex items-center justify-center">
        ...
        {restingHR !== null && (
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="bg-background/50 rounded-md border border-glass-border p-4 cursor-help">
