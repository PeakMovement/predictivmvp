  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        {step === 1 && (
          <div className="bg-white rounded-md border border-slate-200 p-8">
            ...
            <form onSubmit={handleAccountSubmit} className="space-y-5">
              ...
              {error && (
                <div className="text-critical text-sm bg-red-50 border border-red-200 rounded-md px-3 py-2">
                  {error}
                </div>
              )}
        ...
        {/* ── Done ── */}
        {step === "done" && (
          <div className="bg-white rounded-md border border-slate-200 p-10 text-center space-y-5">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-md p-4 text-left space-y-2">
