    ...
    <div className="space-y-7">
      ...
      <div className="space-y-3">
        <div className="flex items-baseline justify-between">
          <label className="font-mono text-[9px] tracking-[0.3em] uppercase text-muted-foreground">
            Life Stress Level
          </label>
          <span className="font-mono text-sm text-coldBlue tracking-wider">
            {data.stressLevel}/10
            <span className="text-[9px] text-muted-foreground/60 ml-2">{stressLabel(data.stressLevel)}</span>
          </span>
        </div>
        <Slider
          ...
          step={1}
        />
        <div className="flex justify-between font-mono text-[8px] tracking-[0.2em] uppercase text-muted-foreground/40">
          <span>Low</span>
          <span>Medium</span>
          <span>High</span>
        </div>
      ...
      <div className="space-y-2">
        <label className="font-mono text-[9px] tracking-[0.3em] uppercase text-muted-foreground">Sleep Quality</label>
        <OnboardingChips
      ...
      {/* Compliance */}
      <div className="space-y-2">
        <label className="font-mono text-[9px] tracking-[0.3em] uppercase text-muted-foreground">Yves Engagement</label>
        <OnboardingChips
