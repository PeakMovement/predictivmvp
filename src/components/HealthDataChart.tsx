...
export default function HealthDataChart() {
  ...
  if (isLoading) {
    return (
      <div className="bg-glass rounded-md border border-glass-border p-8 flex items-center justify-center min-h-[400px]">
  ...
  if (chartData.length === 0) {
    return (
      <div className="bg-glass rounded-md border border-glass-border p-8 ">
