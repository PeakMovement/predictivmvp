import { Home, Dumbbell, Heart, Calendar } from "lucide-react";
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative flex flex-col items-center gap-1 px-6 py-2 rounded-xl transition-all duration-500 ease-out",
