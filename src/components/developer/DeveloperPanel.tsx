...
export const DeveloperPanel = () => {
  ...
  return (
    <div className="bg-glass rounded-md border border-glass-border overflow-hidden transition-all">
      <button
      ...
      {isExpanded && (
        <div className="p-6 pt-0 space-y-6">
          ...
          <div>
            ...
            <div className="bg-black/30 border border-white/10 rounded-md max-h-64 overflow-y-auto">
              {logs.length === 0 ? (
